...
In Your Face is a Python script that allows for hands-free scrolling using facial gestures.

## What does it do?

In Your Face uses OpenCV and dlib to detect if the user is blinking or if the user is opening their mouth. If the user blinks, the program will automatically scroll down, and if the user opens their mouth, the program will scroll up. This works even when the program is minimized, allowing it to seamlessly integrate into everyday life.

## Why is it important?

While it may seem pathetic at first, only saving mere seconds, time adds up quickly over the course of several days and weeks. Whether you use it to keep your hands free while taking notes, or simply to remain productive while you nurse an injury, the marginal benefits of In Your Face will eventually add up. This can allow for students like myself to augment their study efficiency and spend more time on other things that are important to them.

## Who created it?

Me. My name is Derek Xu and I'm a second year student at Queen's University studying Computer Science. I created In Your Face myself during DeltaHacks, and I hope to add more features, such as user-specific calibration after the hackathon.

## Test it for yourself!

You can find the repo [here](https://github.com/Dxiled/InYourFace).

I've provided the entirety of the Bee Movie script below to give ample room for testing.
